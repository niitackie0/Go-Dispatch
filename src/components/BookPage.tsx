    ...
    <div className="relative">
      ...
      <section className="relative overflow-hidden aurora-bg border-b border-slate-200/70">
        ...
        <div className="relative mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 pt-14 pb-10 text-center">
          <span className="text-xs font-mono uppercase tracking-widest text-violet-600 font-semibold">Book a delivery</span>
          ...
          <p className="mt-3 text-slate-600 max-w-xl mx-auto">
            Fill in the pickup and dropoff details, choose a size tier, and pick how you'd like to pay.
          </p>

          <div className="mt-6 flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-xs text-slate-500">
            <span className="flex items-center gap-1.5"><Route className="h-4 w-4 text-violet-600" /> Real-time tracking</span>
            <span className="flex items-center gap-1.5"><Smartphone className="h-4 w-4 text-violet-600" /> Instant MoMo prompt</span>
            <span className="flex items-center gap-1.5"><ShieldCheck className="h-4 w-4 text-violet-600" /> Auditable payments</span>
          </div>
        </div>
      </section>
